...
if (!function_exists('my_asset')) {
    ...
    function my_asset($path, $secure = null)
    {
        if (env('FILESYSTEM_DRIVER') == 's3') {
            ...
            return app('url')->asset('public/' . $path, $secure); #public/
        }
    }
}
...
if (!function_exists('get_main_category_id')) {
    function get_main_category_id($subcategory_id)
    {
        $category = App\Models\Category::where('id', $subcategory_id)->first();
