...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.product.products.create', compact('categories', 'fabrics', 'cassettes', 'mounts', 'brackets', 'springassists', 'roomtypes', 'stacks', 'wraps', ));
    }
     ...
     */
     public function admin_product_edit(Request $request, $id)
     {
        ...
        if(empty($wrap_selected)) {
            ...
            // $wrap_selected->wrap_code = 0;
        }
        // dd($wrap_selected->wrap_code);
        // $wrap_array = [];
        // foreach($wrap_selected as $item) {
        //     $wrap_array[] = $item->wrap_code;
        // }
        ...
        // $ct_wm_selected = ProductControltype::select('ct_widmotor_code')->where('product_id', $id)->where('ct_widmotor_code', '<>', null)->get();
        // $ct_man_array = [];
        ...
        return view('backend.product.products.edit_product', compact('product', 'categories', 'tags', 'fabrics', 'fabric_array', 'cassettes', 'cass_array', 'mounts', 'mount_array', 'brackets', 'bracket_array', 'springassists', 'sa_array', 'roomtypes', 'roomtype_array', 'stacks', 'stack_array', 'wraps', 'wrap_selected'));
