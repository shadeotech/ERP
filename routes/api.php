...
Route::prefix('v3')->group(function () {
    Route::get("/products", 'Api\V3\CartController@products');
    Route::get("/cart/{id}/{seller_id}", 'Api\V3\CartController@product_data_for_cart');
    Route::post("/create-order", 'Api\V3\CartController@create_order');
});
