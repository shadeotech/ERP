...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    // orderstatus
    Route::get('/backend/status/index', 'SellerController@showStatus')->name('backend.status.view');
    Route::get('/backend/status/create', 'SellerController@createStatus')->name('create-status');
    Route::post('/store', 'SellerController@storeStatus')->name('backend.status.store');
    Route::get('/backend/status/destroy/{id}', 'SellerController@destroyStatus')->name('status.destroy');
    Route::get('/backend/status/edit/{id}', 'SellerController@editStatus')->name('status.edit');
    Route::post('/backend/status/update/{id}', 'SellerController@updateStatus')->name('status.update');
    ...
    Route::get('/backend/sellers/verify/{email}', 'SellerController@verify')->name('backend.sellers.verify');
    ...
    Route::get('/email-content-settings', 'BusinessSettingsController@email_content')->name('email_content.index');
    Route::post('/email-content-settings/save', 'BusinessSettingsController@email_content_save')->name('email_content.save');
    ...
    Route::get('/seller_orders/orderlabels/all/{id}', 'OrderController@orders_labels_all')->name('orders.labels.all');
    ...
    Route::get('/seller_orders/line_items/{id}/edit', 'OrderController@edit_lineitems')->name('seller_orders.orders.edit');
    Route::post('/seller_orders/line_items/{id}/update', 'OrderController@update_lineitems')->name('seller_orders.orders.update');
    ...
    Route::get('/move_productions/items/{id}', 'ProductionsController@item_list')->name('production.items');
    Route::post('/productions/formula_ajax/', 'ProductionsController@apply_formulas')->name('production.apply_formula');
    Route::post('/move_productions/save_production', 'ProductionsController@save_production')->name('production.save_production');
    Route::get('/productions/view/{id}', 'ProductionsController@view_production')->name('production.view');
    ...
    Route::get('/order/status', 'AdminFiles@status')->name('order-status');
