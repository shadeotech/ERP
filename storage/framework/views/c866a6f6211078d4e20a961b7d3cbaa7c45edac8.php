...
<head>
    ...
    <!-- Datepicker -->
    <link rel="stylesheet" href="<?php echo e(static_asset('assets/css/jquery-ui.theme.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(static_asset('assets/css/jquery-ui.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(static_asset('assets/css/print.min.css')); ?>">
...
<body>
    ...
    <div class="aiz-main-wrapper d-flex flex-column">
        ...
        <?php //@include('frontend.inc.footer') ?>
    ...
    <?php if(get_setting('facebook_chat') == 1 && config('app.env') == 'production'): ?>
...
<?php /**PATH F:\xampp7\htdocs\ERP\resources\views/frontend/layouts/app.blade.php ENDPATH**/ ?>