    ...
    <div class="aiz-titlebar mt-2 mb-3 text-left">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-md-right">
                <a href="<?php echo e(route('create-status')); ?>" class="btn btn-circle btn-info">
                    <span><?php echo e(translate('Add New Status')); ?></span>
                </a>
            </div>
        </div>
    </div>
                ...
                <table class="mb-0 table" id="my-datatable">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td style="vertical-align:middle;"><?php echo e($status->id); ?></td>
                                <td style="vertical-align:middle;"><?php echo e($status->name); ?></td>
                                <td style="vertical-align:middle;">
                                    <a href="<?php echo e(route('status.edit', $status->id)); ?>" class="btn btn-soft-primary btn-icon btn-circle btn-sm" title="Edit"><i class="las la-edit"></i>
                                    </a>
                                    <a href="<?php echo e(route('status.destroy', $status->id)); ?>" class="btn btn-soft-danger btn-icon btn-circle btn-sm" title="Delete" onclick='return confirm("Are you sure you want to delete this user?")'><i
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp7\htdocs\ERP\resources\views/backend/orderstatus/view.blade.php ENDPATH**/ ?>