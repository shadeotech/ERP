                                                        ...
                                                        <th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    ...
                                                                    <td class="" style="text-align:left;"><img src="{{ asset('public/assets/img/logo-big.png') }}" width="150px" height="110px" border="0" alt="" /></td>
                                                                </tr>
                                                            </table>
                                                        </th>
                                        ...
                                        <tr>
                                            <td class="p30-15" style="padding: 70px 30px 70px 30px;">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    @endif
                                                    <tr>
                                                        <td class="h5 center pb10" style="color:#000000; font-family:'Ubuntu', Arial,sans-serif; font-size:15px; line-height:60px; text-align:center;">Your account email is: {{ $array['email'] }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="h5 center pb10" style="color:#000000; font-family:'Ubuntu', Arial,sans-serif; font-size:15px; line-height:60px; text-align:center; padding-bottom:10px;">Your account password is: {{ $array['pwd'] }}</td>
                                                    </tr>
