...
@section('content')
    <section class="gry-bg py-0">
        <div class="profile">
            <div class="container-fluid" style="background-image: url({{ static_asset('assets/img/admin-bg-login.jpg') }}); background-size: cover; min-height: 100vh;">
                <div class="row">
                    <div class="col-6">
                        <img src="{{ static_asset('assets/img/logo-big.png') }}" class="w-100 mb-4 adm_logo" style="filter: drop-shadow(2px 4px 6px black);">
                    </div>
                    <div class="col-5">
                    <div class="text-center pt-4">
                                <h1 class="h4 fw-600 pt-5">
                            ...
                            <div class="px-4 py-3 py-lg-4">
                                <div class="" >
                                    <form class="form-default" role="form" action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="row mb-2  pb-3">
                                            <div class="col-6">
                                                <label class="aiz-checkbox"  style="opacity:1;">
                                    ...
                                    @if (env("DEMO_MODE") == "On")
                                        <div class="mb-5">
                                            <table class="table table-bordered mb-0">
                                                <tbody>
                                                    <tr>
                                                        <td>{{ translate('Dealer Account')}}</td>
                                                        <td>
                                ...
                                <div class="text-center">
                                    <p class="mb-0">{{ translate('Dont have an account?')}}</p>
