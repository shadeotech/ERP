        ...
        <table class="table aiz-table mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if (($ticket->status == 'pending') && ($ticket->viewed == 0))
                        <span class="badge badge-inline badge-danger">{{ translate('Pending')}}</span>
                        @elseif (($ticket->viewed == 1) && ($ticket->status == 'pending'))
                        ...
                        @elseif (($ticket->viewed == 1) && ($ticket->status == 'viewed'))
            ...
            <div class="modal-body px-3 pt-3">
                <form class="" action="{{ route('support_ticket.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <select name="ticket_number" id="ticket_number" class="form-control mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <input type="date" class="form-control mb-3" id="d_o_s" name="d_o_s"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-10">
                            <input type="time" class="form-control mb-3" id="t_o_s" name="t_o_s"/>
                        </div>
                    </div>
                    <div class="text-right mt-4">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ translate('cancel')}}</button>
