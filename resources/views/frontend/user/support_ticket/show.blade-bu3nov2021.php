        ...
        <div class="card-header row gutters-5">
            <div class="text-center text-md-left">
               ...
               <div class="mt-2">
                   ...
                   <span class="badge badge-inline badge-secondary ml-2"> {{ ucfirst($ticket->tic_status) }} </span>
               </div>
            </div>
        </div>
        <div class="card-body">
            <form action="{{route('support_ticket.seller_store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="reply" data-buttons='[["font", ["bold", "underline", "italic"]],["para", ["ul", "ol"]],["view", ["undo","redo"]]]' rows=5 required></textarea>
                </div>
