...
<!-- <form class="" action="{{route('products.update', $part->id)}}" method="POST" enctype="multipart/form-data" id="choice_form"> -->
    <div class="row gutters-5">
                        ...
                        <div class="card-body">
                            <div class="form-group row mb-3">
                                ...
                                <div class="col-12 col-md-12 col-lg-12 pt-2">
                                    ...
                                    <input type="text" class="form-control" id="price" name="price" readonly value="{{$part->unit_price}}">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-12">
            <div class="mar-all text-right">
                <button type="submit" name="button" id="button" value="publish" onclick="add_to_cart()"
...
<script type="text/javascript">
    ...
    $('#quantity').on('change', function() {
        ...
        var total = parseInt($('#quantity option:selected').val()) * parseInt($('#price').val());
