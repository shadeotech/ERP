    ...
    <div class="col-lg-10 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="h6 mb-0">Order Number: {{ $order->order_number }}</h5>
                <a class="btn btn-success" href="#" onclick="window.print()" target="_blank"><i class="fa fa-print"></i> PRINT</a>
            </div>

            <div class="card-body">
                <div class="form-group row">
                    <div style="background:#8B8B8B;color:white;width:100%;vertical-align:bottom;">
                        <h5 class="pl-1 pt-1">Product Information</h5>
                    </div>
                ...
                <div class="form-group row">
                    <div style="background:#8B8B8B;color:white;width:100%;">
                        <h5 class="pl-1 pt-1">Measurements</h5>
                    </div>
                    <table class="table-stripped table text-center">
                        <thead>
                            <th>Width</th>
                ...
                <div class="form-group row">
                    <div style="background:#8B8B8B;color:white;width:100%;">
                        <h5 class="pl-1 pt-1">Control Type - Motor</h5>
                    </div>
                    <table class="table-stripped table text-center">
                        <thead>
                            <th>Motor Name</th>
                ...
                <div class="form-group row">
                    <div style="background:#8B8B8B;color:white;width:100%;">
                        <h5 class="pl-1 pt-1">Control Type - Manual</h5>
                    </div>
                    <table class="table-stripped table text-center">
                        <thead>
                            <th>Chain Color</th>
                ...
                <div class="form-group row">
                    <div style="background:#8B8B8B;color:white;width:100%;">
                        <h5 class="pl-1 pt-1">Fabric Wrapped</h5>
                    </div>
                    <table class="table-stripped table text-left">
                        <thead>
                            <th>Wrapped Price</th>
                        </thead>
                        <tbody>
                ...
                <div class="form-group row">
                    <div style="background:#8B8B8B;color:white;width:100%;">
                        <h5 class="pl-1 pt-1">Cassette</h5>
                    </div>
                    <table class="table-stripped table text-center">
                        <thead>
                            <th>Cassette Type</th>
                ...
                <div class="form-group row">
                    <div style="background:#8B8B8B;color:white;width:100%;">
                        <h5 class="pl-1 pt-1">Room And Window</h5>
                    </div>
                    <table class="table-stripped table text-center">
                        <thead>
                            <th>Room</th>
                ...
                <div class="form-group row">
                    <div style="background:#8B8B8B;color:white;width:100%;">
                        <h5 class="pl-1 pt-1">Spring Assist</h5>
                    </div>
                    <table class="table-stripped table text-left">
                        <thead>
                ...
                <div class="form-group row">
                    <div style="background:#8B8B8B;color:white;width:100%;">
                        <h5 class="pl-1 pt-1">Special Instructions</h5>
                    </div>
                    <table class="table-stripped table text-left">
                        <thead>
                            <th>Instructions</th>
                ...
                <div class="form-group row">
                    <div style="background:#8B8B8B;color:white;width:100%;">
                        <h5 class="pl-1 pt-1">Shipping Address</h5>
                    </div>
                    <table class="table-stripped table text-left">
                        <thead>
                            <th>Name</th>
                ...
                <div class="form-group row">
                    <div style="background:#8B8B8B;color:white;width:100%;">
                        <h5 class="pl-1 pt-1">More Information</h5>
                    </div>
                    <table class="table-stripped table text-left">
                        <thead>
                            <th>Due Date</th>
