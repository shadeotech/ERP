...
@section('panel_content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-6 col-md-6 col-lg-6 pt-2">
                                ...
                                <input type="text" class="form-control" value="{{ today()->format('Y-m-d') }}" readonly>
                            </div>
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4 pt-2">
                                        ...
                                        <div class="d-flex mb-3 flex-row">
                                            ...
                                            <div class="flex-fill" style="width:40%">
                                                <select class="form-control calc_prices get_fts_prices @if (isset($ct_wid_motors) && !empty($ct_wid_motors)) wm_price @endif" name="wid_decimal" id="wid_decimal" style="font-size:13px; padding-inline: 2px;">
                                    ...
                                    <div class="col-12 col-md-4 col-lg-4 pt-2">
                                        ...
                                        <div class="d-flex mb-3 flex-row">
                                            ...
                                            <div class="flex-fill" style="width:40%">
                                                <select class="form-control calc_prices get_fts_prices @if (isset($ct_wid_motors) && !empty($ct_wid_motors)) wm_price @endif" name="len_decimal" id="len_decimal" style="font-size:13px; padding-inline: 2px;">
                                                    <option selected value="0">Even</option>
                                                    <option value="0.125">1/8</option>
                                                    <option value="0.25">1/4</option>
                                                    <option value="0.375">3/8</option>
    ...
    @endforeach
                                                                                        ...
                                                                                        <img id="fabric_img" src="" class="hide img-fluid mt-4" width="200px" /-->
                                        ...
                                        @foreach ($fabric as $item)
                                            @if ($item->xztfabric->show_in_gallery == 'Yes')
                                                <option data-img="{{ $item->xztfabric->url }}" data-fabric-min-width="{{ $item->xztfabric->min_width }}" data-fabric-max-width="{{ $item->xztfabric->max_width }}"
                                                        data-fab-specs="{{ $item->xztfabric->fab_specs }}" value="{{ $item->fabric_id }}">{{ $item->xztfabric->name }}</option>
                                            @endif
                                        @endforeach
                                    </select>
                                ...
                                <div class="card-body">
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-6 pt-2">
                                            ...
                                            <select class="form-control" name="bottom_rail_color" id="bottom_rail_color" required>
                                            </select>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="card display_price_box">
                    <div class="row pt-3 pl-3 pr-3">
                        <div class="col-md-6">
                            <p class="font-weight-bold">Bottom Rail</p>
                        </div>
                        <div class="col-md-6">
                            <p class="font-weight-bold">Price</p>
                        </div>
                    ...
                    <div class="row pl-3 pr-3 pb-3">
                        <div class="col-md-6">
                            <p class="d-inline" id="txt_bottom_rail"></p>
                            <p class="d-inline">&nbsp;</p>
                        </div>
                        <div class="col-md-6">
                            <p class="d-inline" id="bottom_rail_price"></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card display_price_box">
                    <div class="row pt-2 pb-2 pl-3 text-center">
                        ...
                        <div class="col">
                            <button type="buttom" id="duplicate-product-cart" class="btn btn-primary">Add & Duplicate</button>
                        </div>
                        <div class="col">
                            <button type="submit" name="add_more" id="add_more" value="more" class="btn btn-primary">Add<br>More</button>
                        </div>
                    </div>
                </div>
            </div>
            <!--div class="col-6">
                                                                    <div class="mar-all mr-3 mb-5 text-right">
                                                                        <button type="submit" name="button" id="button" value="publish" class="btn btn-primary">Add to Cart</button>
    ...
    <script type="text/javascript">
        ...
        $('#quantity').change(function() {
            ...
            if ($('#quantity option:selected').val() > 1) {
                ...
                // }
                var chk = parseInt(`{{ isset($brkt_opt_chk) ? $brkt_opt_chk : 0 }}`);
                if (chk > 0) {
                    $("#brackets_opt").removeClass('hide');
        ...
        $("#bottom_rail").change(function() {
            ...
            $("#txt_bottom_rail").text(val);
            $("#bottom_rail_price").text(price);
        ...
        // Ajax for feature price Cassette & Wrapped Fabric TODO:imp
        $('.get_fts_prices').on('change', function(e) {
            ...
            console.log(`cassette_code: ${cassette_code}`);
        ...
        function add_to_cart() {
            ...
            //Price
            var price = $('#discount_txt').text() ? $('#discount_txt').text() : 0;
        ...
        // Duplicating the first cart product
        function duplicateProduct() {
            if (validateForm()) {
                $(".loader-service").removeClass('makeItHidden');
                $(".product-clonned-msg").remove();

                add_to_cart();

                setTimeout(function() {
                    $(".loader-service").addClass('makeItHidden');
                    $(".aiz-titlebar").after('<div class="row"><div class="col"><div class="alert alert-success mb-2 product-clonned-msg">Added to cart and duplicated.</div></div></div>');
                    $("html, body").animate({
                        scrollTop: 0
                    }, "slow");
                }, 3000);
