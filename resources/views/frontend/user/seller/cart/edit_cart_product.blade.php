                                ...
                                <div class="form-group row mb-1">
                                    <div class="col-12 col-md-12 col-lg-12 pt-2">
                                        ...
                                        <div class="col-4 chain_color_box hide mt-2 mb-2 pl-4">
                                            <input type="checkbox" class="form-check-input chain_colors" @if ($order->chain_color == 'White') checked data-checked="true" @endif value="White" id="chain_white" name="chaincolor_arr">
                                        ...
                                        <div class="chain_color_box hide mb-2 pl-4">
                                            <input type="checkbox" class="form-check-input chain_colors" @if ($order->chain_color == 'Black') checked data-checked="true" @endif value="Black" id="chain_black" name="chaincolor_arr">
                                            <label class="form-check-label pt-1" for="chain_black" style="font-size:0.75rem;">Black</label>
                                        </div>
                                        <div class="chain_color_box hide mb-2 pl-4">
                                            <input type="checkbox" class="form-check-input chain_colors" @if ($order->chain_color == 'Steel') checked data-checked="true" @endif value="Steel" id="chain_steel" name="chaincolor_arr">
                                        ...
                                        <div class="cord_color_box hide mb-2 pl-4">
                                            <input type="checkbox" class="form-check-input cord_colors" @if ($order->cord_color == 'Default') checked data-checked="true" @endif value="Default" id="cord_default" name="cordcolor_arr">
                                        ...
                                        <div class="cord_color_box hide mt-2 mb-2 pl-4">
                                            <input type="checkbox" class="form-check-input cord_colors" @if ($order->cord_color == 'White') checked data-checked="true" @endif value="White" id="cord_white" name="cordcolor_arr">
                                            <label class="form-check-label pt-1" for="cord_white" style="font-size:0.75rem;">White</label>
                                        </div>
                                        <div class="cord_color_box hide mb-2 pl-4">
                                            <input type="checkbox" class="form-check-input cord_colors" @if ($order->cord_color == 'Grey') checked data-checked="true" @endif value="Grey" id="cord_grey" name="cordcolor_arr">
                                            <label class="form-check-label pt-1" for="cord_grey" style="font-size:0.75rem;">Grey</label>
                                        </div>
                                        <div class="cord_color_box hide mb-2 pl-4">
                                            <input type="checkbox" class="form-check-input cord_colors" @if ($order->cord_color == 'Beige') checked data-checked="true" @endif value="Beige" id="cord_beige" name="cordcolor_arr">
                                            <label class="form-check-label pt-1" for="cord_beige" style="font-size:0.75rem;">Beige</label>
                                        </div>
                                        <div class="cord_color_box hide mb-2 pl-4">
                                            <input type="checkbox" class="form-check-input cord_colors" @if ($order->cord_color == 'Black') checked data-checked="true" @endif value="Black" id="cord_black" name="cordcolor_arr">
...
@section('script')
    ...
    <script>
        ...
        function motorization_checkbox_click() {
            ...
            $(".chain_colors").prop("checked", false);
            // $('.cord_color_box').hide();
            $('.cord_color_box').removeClass('d-inline');
            $(".cord_colors").prop("checked", false);
        ...
        function add_to_cart() {
            ...
            var suggested_price_prod = parseFloat($("#ttl_price").text() ? $("#ttl_price").text() : 0);
        ...
        $(document).ready(function() {
            ...
            if ($("#manual")[0].checked) {
                if ($("#manual_sel option:selected").text() == "Chain") {
                    ...
                    $('.chain_colors[data-checked="true"]').check()
                }
                if ($("#manual_sel option:selected").text() == "Cord") {
                    $('#cord_ctrl').trigger("change");
                    $('.cord_colors[data-checked="true"]').check()
                }
            }
            if ($("#motorization")[0].checked) {
