    ...
    <script type="text/javascript">
        ...
        $('#shipaddress').on('submit', function(e){
            ...
            jQuery.ajax({
                ...
                type: 'POST',
                data: { 'products': products, 'ship': ship_data },
                success: function(result){
                    if(result == 'success'){
                        localStorage.clear();
