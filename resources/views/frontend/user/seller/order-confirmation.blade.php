	...
	<body>
		<section class="body">
			<section class="invoce_body">
				<div class="centerize-element">
					<img class="ml6 logo" src="{{static_asset('assets/img/logo-big.png')}}" width="150" height="127" />
				</div>

				<div class="invoice_header pt16 mb16">
					<div class="centerize-element">
						<h2><b>Order Confirmation</b></h2>
					</div>
				</div>

				<div class="invoice_header pl30 pr30">
					<div class="sec1">
						<p class="size16 cl_gd">Tag: {{ isset($cart_items[0]) ? $cart_items[0]->project_tag ?? '' : '' }}</p>
						<p class="size16 cl_gd">Sidemark: {{ isset($cart_items[0]) ? $cart_items[0]->cust_side_mark ?? '' : '' }}</p>
					</div>
				</div>
				...
				<div class="invoice_header pl30 pr30">
					<div class="sec1">
						...
						<p class="size16 cl_gd">State: {{ $ship['city'] ?? '' }}</p>
