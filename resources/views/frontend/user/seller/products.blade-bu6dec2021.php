    ...
    <div class="card">
        <div class="card-header row gutters-5 align-right">
            <div class="col-md-4 input-group input-group-sm">
                ...
                <a href="{{route('seller.products')}}">Clear Search</a>
            </div>
            <div class="col-md-4">
                <div class="input-group input-group-sm">
                    <form class="" action="" method="GET">
                        <input type="text" class="form-control" id="search" name="search" @isset($search) value="{{ $search }}" @endisset placeholder="{{ translate('Search product name') }}" style="height:40px;">
                    </form>
                </div>
            </div>
            <div class="col-md-4">
                <form class="" action="" method="GET" >
                    <div class="input-group input-group-sm">
                        ...
                        <select name="searchcat" id="searchcat" class="form-control mr-2" style="height:40px;">
                        ...
                        <input type="submit" class="form-control btn btn-danger" value="Search" style="height:40px;"/>
                    </form>
                </div>
            </div>
        </div>
            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="md" class="text-right">{{ translate('Buy Now')}}</th>
                    </tr>
                </thead>
                    ...
                    @foreach ($products as $key => $product)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('seller.products.cart', ['id'=>$product->id, 'lang'=>env('DEFAULT_LANGUAGE')])}}" class="text-reset link_hover">
                                    {{ $product->name }}
                                </a>
                            </td>
                            <td>
                            ...
                            <td class="text-right">
                              ...
                              <a class="btn btn-soft-info btn-icon btn-circle btn-sm" href="{{route('seller.products.cart', ['id'=>$product->id, 'lang'=>env('DEFAULT_LANGUAGE')])}}" title="{{ translate('Buy') }}">
