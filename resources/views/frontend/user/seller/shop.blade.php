    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="" action="{{ route('shops.update', $shop->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <!-- <div class="row">
                    <div class="col-md-2">
                        <label>{{ translate('Dealer Discount')}} <span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-10">
                        <input type="number" lang="en" min="0" max="100" class="form-control mb-3" placeholder="{{ translate('Dealer Discount (In Percentage)')}}" name="dealer_discount" value="{{ $shop->dealer_discount }}">
                    </div>
                </div> -->
