    ...
    <form id="sort_orders_date" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col-md-6 ml-auto">
                <div class="from-group mb-0">
                    <input type="text" class="form-control" id="searchdate" name="searchdate" @isset($sort_searchdate) value="{{ $sort_searchdate }}" @endisset placeholder="Type date [yyyy-mm-dd] & press enter">
                </div>
            </div>
        </div>
    </form>
        ...
        <table class="table aiz-table mb-0 w-100 p-0 m-0" style="font-size:12px; width:100%;">
            <thead>
                <tr class="text-center">
                    ...
                    <th style="vertical-align:middle;">Dealer Name</th>
            ...
            <tbody>
                ...
                <tr class="text-center">
                    <td style="width:20%;vertical-align:middle;">{{$item->order_number}}</td>
                    <td style="vertical-align:middle;">{{$item->product_id}}</td>
                    <td style="vertical-align:middle;">{{$item->dealer_name}}</td>
                    <td style="vertical-align:middle;">{{$item->tags}}</td>
                    ...
                    <td style="width:10%;vertical-align:middle;">{{$item->due_date}}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
