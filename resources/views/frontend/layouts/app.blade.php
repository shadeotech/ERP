...
<head>
    ...
    <!-- Datepicker -->
    <link rel="stylesheet" href="{{static_asset('assets/css/jquery-ui.theme.min.css')}}">
    ...
    <link rel="stylesheet" href="{{static_asset('assets/css/print.min.css')}}">
...
<body>
    ...
    @if (get_setting('facebook_chat') == 1 && config('app.env') == 'production')
