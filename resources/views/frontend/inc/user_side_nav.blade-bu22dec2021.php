<div class="aiz-user-sidenav-wrap position-relative z-1 shadow-sm">
    <div class="aiz-user-sidenav rounded overflow-auto c-scrollbar-light pb-5 pb-xl-0">
        <div class="p-4 text-xl-center mb-4 border-bottom text-white position-relative" style="background:#151422;">
          ...
          <div class="widget-balance pb-3 pt-1" style="min-height:100vh;">
            <div class="text-center">
                <div class="heading-4 strong-700 mb-4">
                    @php
                        $orderTotal = \App\Models\Xztcart::where('user_id', Auth::user()->id)->where('date', '>=', $days_ago_30)->sum('total_price');
                    @endphp
