...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">Add New Cassette</h5>
</div>

<div class="col-lg-6 mx-auto">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('cassette.store') }}" method="POST" enctype="multipart/form-data">
            	@csrf
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="cassette_code">Cassette Code</label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="Cassette Code" id="cassette_code" name="cassette_code" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="name">Name</label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="Cassette Name" id="name" name="name" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    <label class="col-md-3 col-from-label">Color<span class="text-danger"></span></label>
                    <div class="col-md-9">
                        <input type="text" class="form-control aiz-tag-input" name="colors[]" placeholder="{{ translate('Type and hit enter to add colors') }}" required>
                    </div>
                </div>
                <div class="form-group row">
