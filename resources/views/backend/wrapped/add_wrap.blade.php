...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">Add New Wrap</h5>
</div>

<div class="col-lg-6 mx-auto">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('wrapped.store') }}" method="POST" enctype="multipart/form-data">
            	@csrf
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="wrap_code">Wrap Code</label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="Wrap Code" id="wrap_code" name="wrap_code" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="name">Name</label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="Wrap Name" id="name" name="name" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
