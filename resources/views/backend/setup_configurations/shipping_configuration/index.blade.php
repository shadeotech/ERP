            ...
            <div class="card-body">
                <form action="{{ route('shipping_configuration.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="radio mar-btm">
                        ...
                        <label for="seller-shipping">{{translate('Dealer Wise Flat Shipping Cost')}}</label>
                    </div>
                    <div class="radio mar-btm">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        3. {{ translate('Dealer Wise Flat Shipping Cost calulation: Fixed rate for each seller. If customers purchase 2 product from two seller shipping cost is calculated by addition of each seller flat shipping cost') }}.
                    </li>
                    <li class="list-group-item">
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <ul class="list-group">
                    <li class="list-group-item">
                        {{ translate('1. Shipping cost for admin is applicable if Dealer wise shipping cost is enabled.') }}
                    </li>
                </ul>
            </div>
        </div>
