...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">Add New Springassist</h5>
</div>

<div class="col-lg-6 mx-auto">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('springassist.store') }}" method="POST" enctype="multipart/form-data">
            	@csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="Code" id="option_code" name="option_code" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="Width Limit" id="width_limit" name="width_limit" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-9">
