    ...
    <div class="aiz-titlebar mt-2 mb-3 text-left">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-md-right">
                <a href="{{ route('create-status') }}" class="btn btn-circle btn-info">
                        ...
                        @foreach ($status as $status)
                            <tr>
                                ...
                                <td style="vertical-align:middle;">
                                    <a href="{{ route('status.edit', $status->id) }}" class="btn btn-soft-primary btn-icon btn-circle btn-sm" title="Edit"><i class="las la-edit"></i>
                                    </a>
                                    <a href="{{ route('status.destroy', $status->id) }}" class="btn btn-soft-danger btn-icon btn-circle btn-sm" title="Delete" onclick='return confirm("Are you sure you want to delete this user?")'><i
