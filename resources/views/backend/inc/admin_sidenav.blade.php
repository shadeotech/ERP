        ...
        <div class="aiz-side-nav-logo-wrap">
            <a href="{{ route('admin.dashboard') }}" class="d-block text-left">
                @if (get_setting('system_logo_white') != null)
                    <img class="mw-100" width="200px" src="{{ uploaded_asset(get_setting('system_logo_white')) }}"
                        class="brand-icon" alt="{{ get_setting('site_name') }}">
                @else
                    <img class="mw-100" width="200px" src="{{ static_asset('assets/img/logo-white.png') }}"
                        class="brand-icon" alt="{{ get_setting('site_name') }}">
                @endif
            </a>
        </div>
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if (Auth::user()->user_type == 'admin' || in_array('2', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('backend.status.view') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Status') }}</span> 
                                </a>
                            </li>
                            <!-- <li class="aiz-side-nav-item">
                                <a href="{{-- route('products.admin') --}}" class="aiz-side-nav-link" >
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('product_bulk_upload.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Bulk Import/Export') }}</span>
                                </a>
                            </li>
                            ...
                            <li class="aiz-side-nav-item">
                                ...
                                <ul class="aiz-side-nav-list level-3">
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('controltype.wid_motor.list') }}"
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a class="aiz-side-nav-link" href="{{ route('vend_formula.index') }}">
                                <span class="aiz-side-nav-text">Vendors List</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a class="aiz-side-nav-link" href="{{ route('vend_formula.add') }}">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('seller_verification_form.index') }}" class="aiz-side-nav-link">
                                    <span
                                        class="aiz-side-nav-text">{{ translate('Dealer Verification Form') }}</span>
                                </a>
                            </li>
                        </ul>
                    </li>
                ...
                @if (Auth::user()->user_type == 'admin' || in_array('22', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('uploaded-files.list') }}"
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('backend.status.view') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('All Status') }}</span>
                                @if ($sellers > 0)
                                    <span class="badge badge-info">{{ $sellers }}</span>
                                @endif
                            </a>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('in_house_sale_report.index') }}"
                                    ...
                                    <span
                                        class="aiz-side-nav-text">{{ translate('Finished Goods Product Sale') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                ...
                                @if (\App\Addon::where('unique_identifier', 'seller_subscription')->first() != null &&
                                    ...
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('offline_seller_package_payment_request.index') }}"
                                            class="aiz-side-nav-link">
                                            <span
                                                class="aiz-side-nav-text">{{ translate('Offline Dealer Package Payments') }}</span>
                                            @if (env('DEMO_MODE') == 'On')
                                                <span class="badge badge-inline badge-danger">Addon</span>
                                            @endif
                                        </a>
                ...
                @if (Auth::user()->user_type == 'admin' || in_array('14', json_decode(Auth::user()->staff->role->permissions)))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('email_content.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Email Content') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
