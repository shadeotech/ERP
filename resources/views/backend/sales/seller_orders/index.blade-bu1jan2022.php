            ...
            <tbody>
                ...
                <tr>
                    <td style="vertical-align:middle;">
                        <a href="{{route('seller_orders.ord_details', $item->order_no)}}" class="" title="">{{$item->order_no}}</a>
                    </td>
                    ...
                    <td>@if($item->status != 'Pending')
                        <a href="{{route('seller_orders.main_ord_delivery_note', $item->id)}}" class="" title="">View Note</a>@endif
                    </td>
                </tr>
                @endforeach
            </tbody>
