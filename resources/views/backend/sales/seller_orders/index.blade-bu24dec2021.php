    ...
    <div class="card-body">
        <table class="table aiz-table mb-0 w-100 p-0 m-0" style="font-size:12px; width:100%;">
            ...
            <tbody>
                ...
                <tr>
                    <td style="width:16%;vertical-align:middle;">{{ $item->id }}</a></td>
                    ...
                    <td style="vertical-align:middle;">
                        <a href="{{route('seller_orders.get_lineitems', $item->id)}}" class="" title="">Details</a>
                    </td>
                    ...
                    <td>
                        <a href="{{route('production.index', $item->id)}}" class="" title="">Move to order production</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
