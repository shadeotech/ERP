...
<body>
    <div>
        ...
        <div style="background: #eceff4;padding: 1rem;">
            <table>
                <tr>
                    ...
                    <td style="font-size: 1.5rem;" class="strong text-right">{{ translate('INVOICE') }}</td>
                </tr>
            </table>
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td class="small text-right"><span class="gry-color small">{{ translate('Order ID') }}:</span> <span class="strong">{{ $order->code }}</span></td>
                </tr>
                <tr>
                    <td class="gry-color small">{{ translate('Phone') }}: {{ get_setting('contact_phone') }}</td>
                    <td class="small text-right"><span class="gry-color small">{{ translate('Order Date') }}:</span> <span class="strong">{{ date('d-m-Y', $order->date) }}</span></td>
                </tr>
            </table>
        ...
        <div style="padding: 1rem;">
            <table class="padding small border-bottom text-left">
                <thead>
                    ...
                    @foreach ($order->orderDetails as $key => $orderDetail)
                        @if ($orderDetail->product != null)
                            <tr class="">
                                ...
                                <td class="currency text-right">{{ single_price($orderDetail->price + $orderDetail->tax) }}</td>
                            </tr>
                        @endif
                    @endforeach
                </tbody>
        ...
        <div style="padding:0 1.5rem;">
            <table style="width: 40%;margin-left:auto;" class="sm-padding small strong text-right">
                <tbody>
                    <tr>
                    ...
                    <tr>
                        <th class="strong text-left">{{ translate('Grand Total') }}</th>
