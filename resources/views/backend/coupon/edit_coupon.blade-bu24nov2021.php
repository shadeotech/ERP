        ...
        <div class="card-body">
            <form action="{{ route('coupon.update', $coupon->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="Coupon Name" id="name" name="name" class="form-control" value="{{$coupon->name}}" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="discount">Discount</label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="Price" id="discount" name="discount" class="form-control" value="{{$coupon->discount}}" required>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-9">
