...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">Add New Coupon</h5>
</div>
        ...
        <div class="card-body">
            <form action="{{ route('coupon.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="Coupon Name" id="name" name="name" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="discount">Discount</label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="Price" id="discount" name="discount" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-9">
