...
@section('content')
    <div class="aiz-titlebar mt-2 mb-3 text-left">
        <h5 class="h6 mb-0">Add New Fabric</h5>
    </div>
            ...
            <div class="card-body">
                <form action="{{ route('fabric.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="Fabric Specifiaction" id="fab_specs" name="fab_specs" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-6 d-flex flex-column">
                            ...
                            <input type="number" class="form-control" min="0" name="min_width" id="min-width" onkeypress="return event.key != '-';">
                        </div>
                        <div class="col-md-6 d-flex flex-column">
                            <label for="max-width">Maximum Width</label>
                            <input type="number" class="form-control" min="0" name="max_width" id="max-width" onkeypress="return event.key != '-';">
                        </div>
                    </div>
