            ...
            <table class="table aiz-table mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:middle;"><img src="{{ static_asset('products/images').'/'.$product->thumbnail_img}}" alt="Image" class="size-50px img-fit"></td>
                        ...
                        <td style="vertical-align:middle;" class="text-right">
                            ...
                            <a href="{{route('products.admin.destroy', $product->id)}}" class="btn btn-soft-danger btn-icon btn-circle btn-sm "  title="Delete" onclick='return confirm("Are you sure you want to delete this item?")'><i class="las la-trash"></i>
                            </a>
                            @else
