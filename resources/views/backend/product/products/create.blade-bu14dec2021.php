    ...
    <form class="form form-horizontal mar-top" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
        <div class="row gutters-5">
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Fabric')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12" >
                                <label style="font-size:15px;">Select Fabric</label>
                                <select class="form-control mb-3 aiz-selectpicker" name="fabric[]" id="fabric" style="height: 210px;" multiple required data-live-search="true">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12" >
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addFabricModal">Add Fabric</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Cassettes')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label style="font-size:15px;">Select Cassette</label>
                                <select class="form-control mb-3" name="cassette[]" id="cassette" style="height: 210px;" multiple>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Mounts')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label style="font-size:15px;">Select Mount</label>
                                <select class="form-control mb-3" name="mount[]" id="mount" style="height: 210px;" multiple>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Brackets')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label style="font-size:15px;">Select Bracket</label>
                                <select class="form-control mb-3" name="bracket[]" id="bracket" style="height: 210px;" multiple required>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Springassists')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label style="font-size:15px;">Select Springassist</label>
                                <select class="form-control mb-3" name="springassist[]" id="springassist" style="height: 210px;" multiple>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Room Types')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label style="font-size:15px;">Select Room Type</label>
                                <select class="form-control mb-3" name="roomtype[]" id="roomtype" style="height: 210px;" multiple required>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Stack')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label style="font-size:15px;">Select Stack</label>
                                <select class="form-control mb-3" name="stack[]" id="stack" style="height: 210px;" multiple>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Fabric Wrapped')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Manual Control Type')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                            <label style="font-size:15px;">Select Manual Control</label>
                                <select class="form-control mb-3" name="ct_manual[]" id="ct_manual" style="height: 210px;" multiple required>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Motor Control Type')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                            <label style="font-size:15px;">Select Motor Control</label>
                                <select class="form-control mb-3" name="ct_motor[]" id="ct_motor" style="height: 210px;" multiple>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Width Control Type')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <select class="form-control mb-3" name="ct_wid_motor" id="ct_wid_motor">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Wand')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                            <label style="font-size:15px;">Select Wand</label>
                                <select class="form-control mb-3" name="wand[]" id="wand" style="height: 210px;" multiple>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Product Image')}}</h5>
                    </div>
                    <div class="card-body">
                        <!--div class="form-group row d-none">
                        ...
                        <!--div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <span style="color:red; font-weight:bold;" id="img_err"></span>
                                <div class="file-preview box sm">
                                </div>
                                <small class="text-muted mb-3">{{translate('This image is visible in all product box. Use 300x300 sizes image. Keep some blank space around main object of your image as we had to crop some edge in different devices to make it responsive.')}}</small>
                            </div>
                        </div-->
                        <div class="form-group row">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">Pricing codes for the product.</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">Is product active?</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-12">
                <div class="btn-toolbar  mb-3" role="toolbar" aria-label="Toolbar with button groups">
                    ...
                    <div class="btn-group mr-2 d-none" role="group" aria-label="Third group">
...
<script type="text/javascript">
    ...
    $('#category_id').change(function () {
        var parent_cat = $('#category_id option:selected').attr('data-parent');
        if(parent_cat > 1 ) {
            $('#cassette option').each(function() {
                if(parent_cat == $(this).attr('data-cassette-cat')) {
                    $(this).removeClass('d-none');
                }else if($(this).attr('data-cassette-cat') == 0) {
                    $(this).removeClass('d-none');
                }else {
    ...
    // $('#addfabric_btn').click(function (e) {
    //     e.preventDefault();
    //     $.ajaxSetup({
    //         headers: {
    //             'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
