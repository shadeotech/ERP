            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">Name/Category</label>
                        <div class="col-md-9">
                            <input type="text" placeholder="Name/Subcategory" id="name" name="name" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select name="digital" required class="form-control aiz-selectpicker mb-2 mb-md-0">
                                ...
                                <option value="1">{{translate('Parts')}}</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
