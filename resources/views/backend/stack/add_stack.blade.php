...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">Add New Stack</h5>
</div>
        ...
        <div class="card-body">
            <form action="{{ route('stack.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="Stack Name" id="name" name="name" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="position">Position</label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="Stack Position" id="position" name="position" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
